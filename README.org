...
laser diode that can be used to kill the target. According to Kare, it
takes 50-100 mJ to kill a mosquito. This table shows how long we'll
have to keep beams of differing power on the insect to kill it.

| Desired Energy (mJ) | Diode Power (mW) | Required Time (s) |
|---------------------+------------------+-------------------|
|                  50 |                5 |             10.00 |
|                  50 |               50 |              1.00 |
|                  50 |              100 |              0.50 |
...
I suspect we won't be able to keep a laser on a flying insect for 10
to 20 seconds, and over so much time the insect may shed enough energy
to extend the required time. One to two seconds seems manageable,
though. I think we should test with a 50 mW diode as an initial kill
laser. 50 mW lasers are easy to find in the $15-$20 range.
